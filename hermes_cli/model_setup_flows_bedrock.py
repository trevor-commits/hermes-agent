...
def _model_flow_bedrock_api_key(config, region, current_model=""):
    ...
    existing_key, existing_source, credential_base = _resolve_api_key_provider_secret("bedrock", bedrock_pconfig)
    from hermes_cli.model_setup_flows_common import _retained_credential_allows_endpoint
