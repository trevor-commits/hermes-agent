...
def _ensure_flow_api_key(provider_id: str, pconfig, *, missing_hint=()) -> tuple[str, str, bool, str]:
    ...
    Returns ``(existing_key, resolved_key, abort, retained_endpoint)``.
    """
    ...
    return existing_key, resolved, abort, credential_base if resolved == existing_key else ""
