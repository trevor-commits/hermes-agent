...
def test_distinct_direct_source_card_results_never_coalesce():
    ...
    assert GatewayRunner._event_route_key(first, GatewayRunner._ASYNC_GROUP_KEY_FIELDS) != GatewayRunner._event_route_key(second, GatewayRunner._ASYNC_GROUP_KEY_FIELDS)
