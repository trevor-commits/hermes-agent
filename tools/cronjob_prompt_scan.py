...
def _scan_cron_skill_assembled(assembled: str, *, benign_deception_phrases: tuple[str, ...] = ()) -> tuple[str, str]:
    ...
    return cleaned, _first_pattern_error(prompt_to_scan, _CRON_SKILL_ASSEMBLED_PATTERNS)
