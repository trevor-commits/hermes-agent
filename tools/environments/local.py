...
def _kill_process_group_posix(proc) -> None:
    ...
    try:
        ...
        # Darwin can refuse a signal to an already-exited, unreaped group.
        # Reap and verify disappearance; a live group's permission failure remains an error.
        if not _wait_for_group_exit(proc, pgid, 0):
            raise
