...
# After this grace window, an idle orphaned WS session is reaped. Running turns
# and their delegations survive transport loss and are reaped after completion.
...
def _interrupt_session_turn(
    ...
    Returns whether the interrupt used the compute-host control channel.
    """
