...
DEFERRED_INDEX_SQL = ASYNC_DELEGATIONS_INDEX_SQL + """
...
def _ended_by_continuation(row) -> bool:
    """A published continuation fences transcript writes to its old parent."""
    return row is not None and row["ended_at"] is not None and row["end_reason"] in {"compression", "proactive_rollover"}
