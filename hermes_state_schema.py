...
from hermes_state_common import (
    ASYNC_DELEGATIONS_INDEX_SQL, DEFERRED_INDEX_SQL, FTS_CJK_STALE_KEY, FTS_REBUILD_DEFERRAL_KEY, FTS_STALE_KEY, FTS_SQL,
...
def reconcile_state_schema(conn: sqlite3.Connection) -> None:
    ...
    conn.executescript(ASYNC_DELEGATIONS_INDEX_SQL)
