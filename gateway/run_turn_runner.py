...
class TurnRunner:
    ...
    def run_sync(self):
        ...
        """
        from gateway.run_turn import _gateway_context_ceiling_result_fields
        ...
        common = {
            ...
            **_gateway_context_ceiling_result_fields(result),
        ...
        if not final_response:
            ...
            # Persistence and context-safety evidence survive an empty response.
