...
class SessionEntry:
    ...
    # Durable first-turn auto-skill admission, cleared across all routing aliases.
    ...
    _RESET_FIELDS = (
        "is_fresh_reset", "auto_skill_pending", "was_auto_reset", "auto_reset_reason", "reset_had_activity",
        "prev_session_id",
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        result["auto_skill_claim_token"] = self.auto_skill_claim_token
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "SessionEntry":
        ...
        claim = data.get("auto_skill_claim_token")
        ...
        return cls(
            ...
            active_turn_token=token, active_turn_started_at=started_at, auto_skill_claim_token=claim,
    ...
    def reset_session(self, session_key: str, display_name: Optional[str] = None) -> Optional[SessionEntry]:
        ...
        with self._lock:
            ...
            new_entry = self._replace_route_locked(
                ...
                is_fresh_reset=True, auto_skill_pending=True,
            )
