...
class GatewayNotificationsMixin:
    ...
    _ASYNC_GROUP_KEY_FIELDS = (
        "session_key", "parent_session_id", "delivery_mode", "work_kind", "work_key",
    ...
    async def _deliver_completion_notification(
        ...
        """
        from gateway.source_card_prefetch import _SOURCE_CARD_INTAKE_ROUTE
        ...
        try:
            ...
            if evt.get("delivery_mode") == "direct" and evt.get("work_kind") == _SOURCE_CARD_INTAKE_ROUTE:
                injection_result = await self._send_direct_async_delegation_completion(evt)
            else:
