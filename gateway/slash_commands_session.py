...
class GatewaySessionCommandsMixin:
    ...
    async def _prepare_retry_turn(self, event: MessageEvent, session_entry) -> Optional[str]:
        """Prepare a retry while the caller retains the resolved session turn lease."""
