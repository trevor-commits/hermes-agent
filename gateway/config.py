...
class GatewayConfig:
    ...
    _SCALAR_DICT_FIELDS = (
        "write_sessions_json", "proactive_rollover_enabled", "proactive_rollover_threshold_tokens", "always_log_local", "filter_silence_narration", "stt_enabled",
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GatewayConfig":
        ...
        return cls(
            ...
            **{name: _coerce_bool(data.get(name), default) for name, default in _TOPLEVEL_BOOL_DEFAULTS.items()},
            proactive_rollover_enabled=_coerce_bool(pick("proactive_rollover_enabled"), False),
            proactive_rollover_threshold_tokens=_coerce_int(pick("proactive_rollover_threshold_tokens"), 24000),
