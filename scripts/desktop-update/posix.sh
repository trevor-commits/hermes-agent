...
# State can live outside the source install (profiles, external disks).
# Desktop supplies its actual home; keep every child and receipt there.
HERMES_HOME="${HERMES_HOME:-${INSTALL_ROOT:+$(dirname "$INSTALL_ROOT")}}"
export HERMES_HOME="${HERMES_HOME:-${TMPDIR:-/tmp}}"
