...
CODING_AGENT_GUIDANCE = (
    ...
    "\n"
    "Respect the user's repo: user requests and repository-specific instructions "
    "are authoritative for state moves such as committing and pushing. When "
    "those instructions are silent, don't commit, push, or rewrite history. "
    "Never read, print, or commit secrets — leave `.env` and "
