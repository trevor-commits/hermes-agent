...
def _parse_compression_config(agent, _agent_cfg) -> CompressionSettings:
    ...
    return CompressionSettings(
        ...
        hard_ceiling_tokens=_positive_int(cfg.get("hard_ceiling_tokens")),
        max_deterministic_attempts=max(0, _parse_config_int(cfg.get("max_deterministic_attempts", 1), 1)),
        deterministic_trim_max_deficit=max(0, _parse_config_int(cfg.get("deterministic_trim_max_deficit_tokens", 4000), 4000)),
...
def _build_context_engine(agent, _agent_cfg, cs, _custom_providers, _effective_context_length, session_db):
    ...
    agent._hard_ceiling_tokens = cs.hard_ceiling_tokens
    ...
    for _attr, _value in (
        ("max_deterministic_attempts", cs.max_deterministic_attempts),
        ("deterministic_trim_max_deficit_tokens", cs.deterministic_trim_max_deficit),
...
_PASSTHROUGH_PARAMS = (
    ...
    # Toolset filtering
    "enabled_toolsets", "disabled_toolsets", "tool_result_max_chars",
...
def init_agent(
    ...
    tool_result_max_chars: int | None = None, cwd: Optional[str] = None,
):
