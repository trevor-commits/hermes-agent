...
def _resolve_provider_aware_context_length(model: str, base_url: str, api_key: str, provider: str, effective_provider: str) -> Optional[int]:
    ...
    if effective_provider:
        ...
        # Cold context resolution must not block on an external-volume cache.
        ctx = lookup_models_dev_context(effective_provider, model, allow_network=False, allow_disk=False)
        if ctx:
