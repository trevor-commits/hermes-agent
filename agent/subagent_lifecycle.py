...
class SubagentLifecycleService:
    ...
    def launch(self, request: SubagentLaunchRequest) -> SubagentHandle:
        ...
        from tools.delegate_tool import _get_max_child_iterations
        ...
        child = _build_child_preserving_parent_tools(
            ...
            model=request.model, max_iterations=_get_max_child_iterations(), task_count=1, parent_agent=parent, role=request.role,
        )
